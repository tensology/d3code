...
test("session surface formats elapsed time for active work", () => {
  ...
  assert.equal(formatBusyStatus("streaming response", 5), "streaming response… 5s  Esc to interrupt")
  assert.equal(formatBusyStatus("streaming response", 5, "↓ 12 tokens"), "streaming response… 5s · ↓ 12 tokens  Esc to interrupt")
  assert.equal(formatBusyStatus("streaming response", 5, "↓ 12 tokens", "esc again to interrupt"), "streaming response… 5s · ↓ 12 tokens  Esc again to interrupt")
