...
import { createCockpitTerminalContract, type CockpitTerminalContract } from "../d3/cockpit-terminal.js"
...
export interface CockpitReport {
  ...
  terminal: CockpitTerminalContract
  nextCommands: string[]
}
...
export async function createCockpitReport(config: D3CodeConfig, state: CockpitState = {}, goalOverride?: D3Goal[]): Promise<CockpitReport> {
  ...
  const terminal = createCockpitTerminalContract(profile)
