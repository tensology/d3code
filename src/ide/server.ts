...
function html(): string {
  return [
    ...
    "<div id=\"terminalView\" class=\"chat-layout\"><aside class=\"chat-sidebar\"><div class=\"dock\"><div class=\"dock-head\"><div class=\"dock-title\">Session</div><button id=\"newTerminalChat\">New chat</button></div><div class=\"dock-body\"><div class=\"nav-section\"><div class=\"nav-kicker\">Chats</div><div id=\"terminalChatList\" class=\"chat-list\"></div></div></div></div></aside><main class=\"terminal-main\"><div class=\"dock-head\"><div><div class=\"dock-title\">D3 Terminal</div><div class=\"dock-sub\">TCL session</div></div></div><div class=\"dock-body\"><div id=\"terminalMain\" class=\"terminal\" tabindex=\"0\" role=\"textbox\" aria-label=\"D3 runtime terminal\"></div></div></main><aside class=\"chat-info\"><div class=\"dock agent-shell\"><div class=\"dock-head\"><div class=\"dock-title\">Current chat</div><div class=\"dock-sub\" id=\"terminalAgentSafety\"></div></div><div class=\"dock-body agent-chat\"><div id=\"terminalAgentOutput\" class=\"agent-thread\"></div><div class=\"agent-composer\"><textarea id=\"terminalAgentPrompt\" class=\"agentbox\" placeholder=\"Message D3 Code...\"></textarea><div class=\"agent-actions\"><button class=\"primary\" id=\"terminalAgentSend\">Send</button></div></div></div></div></aside></div>",
