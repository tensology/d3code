...
function html(): string {
  return [
    ...
    "<style>",
    ":root{color-scheme:dark;font-family:Inter,ui-sans-serif,system-ui,-apple-system,BlinkMacSystemFont,'Segoe UI',sans-serif;background:#081019;color:#dbe7f3;--bg:#081019;--chrome:#0c1520;--rail:#0f1b27;--panel:#121f2d;--panel2:#172635;--editor:#0a121b;--line:#243448;--line2:#304256;--text:#dbe7f3;--muted:#8293a7;--soft:#aebed0;--accent:#35c49a;--accent2:#65a9ff;--warn:#f4b860;--danger:#ff6b6b}",
    "*{box-sizing:border-box}body{margin:0;min-height:100vh;background:var(--bg);color:var(--text)}button,input,select,textarea{font:inherit}button{min-height:32px;border:1px solid var(--line2);background:#172432;color:var(--text);border-radius:5px;padding:0 10px;cursor:pointer;font-size:12px;font-weight:650;letter-spacing:0;line-height:1.12;white-space:nowrap}button:hover{background:#1d3042;border-color:#496178}button.primary{background:var(--accent);color:#04100d;border-color:var(--accent);box-shadow:0 0 0 1px rgba(53,196,154,.18)}input,select,textarea{width:100%;border:1px solid var(--line2);background:#0a131d;color:var(--text);border-radius:5px;padding:8px 9px;font-size:12px;outline:none}input:focus,select:focus,textarea:focus{border-color:var(--accent2);box-shadow:0 0 0 2px rgba(101,169,255,.14)}textarea{font-family:ui-monospace,SFMono-Regular,Menlo,Consolas,monospace;resize:vertical}",
    ".top{height:44px;display:grid;grid-template-columns:260px 1fr auto;align-items:center;border-bottom:1px solid var(--line);background:#0a141f;padding:0 12px;gap:14px}.brand{display:flex;align-items:center;gap:10px;font-weight:760;font-size:14px}.brand-mark{display:grid;place-items:center;width:24px;height:24px;border:1px solid rgba(53,196,154,.5);border-radius:6px;color:var(--accent);font-family:ui-monospace,SFMono-Regular,Menlo,monospace}.crumbs{display:flex;align-items:center;gap:8px;color:var(--muted);font-size:12px;min-width:0}.status-pill{border:1px solid var(--line);background:#111f2c;color:var(--soft);padding:4px 8px;border-radius:999px;white-space:nowrap}.meta{font-size:12px;color:var(--soft);overflow:hidden;text-overflow:ellipsis;white-space:nowrap}",
    ".layout{display:grid;grid-template-columns:300px minmax(380px,1fr) 340px;grid-template-rows:minmax(420px,1fr) 248px;height:calc(100vh - 44px);min-height:720px}.sidebar{grid-row:1/3;background:var(--rail);border-right:1px solid var(--line);display:flex;flex-direction:column;min-width:0}.right{background:var(--rail);border-left:1px solid var(--line);min-width:0}.runtime{grid-column:2/4;background:#09111a;border-top:1px solid var(--line);min-width:0}main{min-width:0;background:var(--editor);display:flex;flex-direction:column}.dock{height:100%;display:flex;flex-direction:column;min-height:0}.dock-head{min-height:38px;display:flex;align-items:center;justify-content:space-between;gap:10px;border-bottom:1px solid var(--line);padding:0 12px;background:#101b27}.dock-title{font-size:12px;font-weight:760;text-transform:uppercase;color:#c7d6e6;letter-spacing:.02em}.dock-sub{font-size:11px;color:var(--muted);white-space:nowrap}.dock-body{padding:12px;overflow:auto;min-height:0;flex:1}.panel{border-bottom:1px solid var(--line);background:transparent}.panel:last-child{border-bottom:0}.panel h2{font-size:12px;line-height:1;margin:0 0 10px;color:#cbd9e8;text-transform:uppercase;letter-spacing:.02em}.panel .body{padding:0}",
    ".tabs{display:grid;grid-template-columns:1fr;gap:4px;padding:10px;border-bottom:1px solid var(--line);background:#0c1722}.tab{height:auto;text-align:left;display:grid;grid-template-columns:22px 1fr;gap:8px;align-items:start;border-color:transparent;background:transparent;padding:9px 8px;color:var(--soft)}.tab b{display:block;font-size:12px;color:inherit}.tab span{display:block;font-size:11px;color:var(--muted);font-weight:500;margin-top:2px}.tab.active{background:#152638;color:#fff;border-color:#2d455e;box-shadow:inset 3px 0 0 var(--accent)}.tab.active span{color:#9fb1c5}.glyph{width:18px;height:18px;display:grid;place-items:center;color:var(--accent2);font-family:ui-monospace,SFMono-Regular,Menlo,monospace}.pane{display:none}.pane.active{display:block}",
    ".row{display:flex;gap:8px;align-items:center;margin-bottom:8px}.row>*{flex:1}.row button{flex:0 0 auto}.stack{display:grid;gap:8px}.label{font-size:11px;font-weight:750;color:var(--muted);margin:12px 0 6px;text-transform:uppercase;letter-spacing:.04em}.hint{font-size:11px;color:var(--muted);line-height:1.45;margin:6px 0 10px}.list{font-family:ui-monospace,SFMono-Regular,Menlo,Consolas,monospace;font-size:12px;line-height:1.5;white-space:pre-wrap;background:#09131d;border:1px solid var(--line);border-radius:6px;padding:10px;min-height:92px;color:#c9d7e8}.mini{min-height:70px}.check{display:flex;gap:7px;align-items:center;color:var(--muted);font-size:12px;margin:8px 0}.check input{width:auto}.toolbar{min-height:38px;display:flex;align-items:center;gap:8px;border-bottom:1px solid var(--line);background:#111d29;padding:0 10px}.editor-actions{height:auto;min-height:44px;flex-wrap:wrap;padding:6px 10px}.editor-actions .check{flex:1 1 185px;margin:0}.tool-chip{height:24px;border:1px solid var(--line);border-radius:4px;padding:4px 7px;color:var(--muted);font-size:11px;background:#0b151f}.tool-chip.hot{color:#07211a;background:#37c79c;border-color:#37c79c}",
    ".editor-wrap{display:grid;grid-template-columns:44px 1fr;min-height:0;flex:1}.gutter{background:#08111a;border-right:1px solid var(--line);color:#496075;font-family:ui-monospace,SFMono-Regular,Menlo,Consolas,monospace;font-size:12px;line-height:22px;padding:12px 8px;text-align:right;user-select:none}.editor{border:0;border-radius:0;background:#0b141e;min-height:430px;height:100%;padding:12px 14px;line-height:22px;font-size:13px;color:#d6e4f2;tab-size:2}.editor:focus{box-shadow:none;border:0}.editor-fields{display:grid;grid-template-columns:minmax(130px,1fr) minmax(160px,1.3fr) auto;gap:8px;padding:10px;border-bottom:1px solid var(--line);background:#0f1a25}",
    ".agent-shell{height:100%;display:flex;flex-direction:column}.agent-thread{background:#0a131d;border:1px solid var(--line);border-radius:6px;min-height:180px;max-height:300px;overflow:auto;padding:10px;margin-top:10px}.agent-message{font-size:13px;line-height:1.5;color:#d8e5f3;white-space:pre-wrap}.tool-event{margin-top:9px;border:1px solid #28415b;background:#101f2d;border-radius:5px;padding:8px}.tool-name{font-family:ui-monospace,SFMono-Regular,Menlo,monospace;font-size:11px;color:var(--accent);font-weight:750}.agentbox{min-height:250px;line-height:1.45;background:#0b151f}.agent-actions{display:flex;justify-content:flex-end;margin-top:8px}",
    ...
    "</main>",
    "<section class=\"right\"><div class=\"dock agent-shell\"><div class=\"dock-head\"><div class=\"dock-title\">Agent</div><div class=\"dock-sub\">D3-only tool loop</div></div><div class=\"dock-body\"><textarea id=\"agentPrompt\" class=\"agentbox\" placeholder=\"Ask D3 Code to inspect this account, explain a dictionary, read a BASIC item, trace a subroutine, or prepare a guarded change.\"></textarea><div class=\"agent-actions\"><button class=\"primary\" id=\"agentSend\">Ask agent</button></div><div id=\"agentOutput\" class=\"agent-thread\"><div class=\"agent-message\">Connect to a profile, then ask in plain English. The agent can use D3 tools for files, DICT items, BASIC source, locks, AQL, indexing, and guarded writes.</div></div></div></div></section>",
    ...
    "function showAgent(v){if(v.error){$('agentOutput').innerHTML='<div class=\"agent-message\">'+escapeHtml(v.error)+'</div>';return}const tools=(v.tools||[]).map(t=>'<div class=\"tool-event\"><div class=\"tool-name\">'+escapeHtml(t.name||'tool')+'</div><div class=\"agent-message\">'+escapeHtml(t.result||'')+'</div></div>').join('');$('agentOutput').innerHTML='<div class=\"agent-message\">'+escapeHtml(v.output||JSON.stringify(v,null,2))+'</div>'+tools}",
    ...
    "$('agentSend').onclick=async()=>showAgent(await api('/api/agent',{method:'POST',headers:{'content-type':'application/json'},body:JSON.stringify({input:$('agentPrompt').value})}));",
