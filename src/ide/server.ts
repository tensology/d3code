...
function html(): string {
  return [
    ...
    ".agent-shell{height:100%;display:flex;flex-direction:column}.agent-chat{padding:0;display:grid;grid-template-rows:1fr auto;height:100%;overflow:hidden}.agent-thread{overflow:auto;padding:14px;display:grid;align-content:start;gap:10px;background:var(--rail)}.chat-bubble{max-width:92%;border:1px solid var(--line);border-radius:10px;padding:10px 11px;background:var(--bubble);font-size:13px;line-height:1.45;white-space:normal}.chat-bubble.user{justify-self:end;background:var(--bubble-user);border-color:rgba(79,140,255,.45)}.chat-bubble.assistant{justify-self:start}.message-head{display:flex;align-items:center;justify-content:space-between;gap:12px;margin-bottom:7px}.message-meta{font-size:11px;color:var(--muted);font-weight:700}.copy-message{min-height:24px;padding:0 7px;font-size:11px;border-radius:4px;color:var(--muted);background:transparent}.message-body{overflow-wrap:anywhere}.message-body p{margin:0 0 12px}.message-body p:last-child{margin-bottom:0}.message-body ul{margin:6px 0 12px 18px;padding:0}.message-body li{margin:4px 0}.message-body strong{font-weight:780;color:var(--text)}.message-body code{font-family:ui-monospace,SFMono-Regular,Menlo,Consolas,monospace;font-size:.92em;background:var(--panel2);border:1px solid var(--line);border-radius:4px;padding:1px 4px}.message-body pre{margin:8px 0 0;padding:10px;border:1px solid var(--line);border-radius:6px;background:var(--editor);overflow:auto;white-space:pre}.tool-event{max-width:92%;justify-self:start;border:1px solid var(--line);background:var(--panel2);border-radius:7px;padding:9px;display:grid;gap:5px}.tool-event.running{border-color:rgba(244,184,96,.55)}.tool-name{font-family:ui-monospace,SFMono-Regular,Menlo,monospace;font-size:11px;color:var(--accent2);font-weight:750}.tool-status{font-size:11px;color:var(--muted);font-weight:700}.chat-tool-result{font-size:12px;line-height:1.45;white-space:pre-wrap;overflow-wrap:anywhere}.agent-composer{border-top:1px solid var(--line);padding:10px;background:var(--panel)}.agentbox{min-height:72px;max-height:140px;line-height:1.45;background:var(--editor)}.agent-actions{display:flex;justify-content:flex-end;margin-top:8px}",
    "#chatView{display:none}.chat-layout{height:calc(100vh - 44px);min-height:680px;grid-template-columns:290px minmax(420px,1fr) 320px;background:var(--bg)}body[data-view='chat'] #chatView{display:grid}body[data-view='chat'] #editorView{display:none}.chat-sidebar,.chat-info{background:var(--rail);border-right:1px solid var(--line);min-width:0;min-height:0}.chat-info{border-right:0;border-left:1px solid var(--line)}.chat-main{grid-column:auto;grid-row:auto;background:var(--editor);min-height:0;display:grid;grid-template-rows:auto 1fr auto}.chat-list{display:grid;align-content:start;gap:6px}.chat-item{height:auto;min-height:56px;text-align:left;display:grid;gap:3px;white-space:normal;background:transparent;border-color:transparent;color:var(--text);padding:8px}.chat-item.active{background:var(--panel);border-color:var(--line2);box-shadow:inset 3px 0 0 var(--accent)}.chat-item b{font-size:12px;overflow:hidden;text-overflow:ellipsis;white-space:nowrap}.chat-item span{font-size:11px;color:var(--muted);font-weight:500;overflow:hidden;text-overflow:ellipsis;white-space:nowrap}.nav-section{border-bottom:1px solid var(--line);padding:12px}.nav-section:last-child{border-bottom:0}.nav-kicker{font-size:10px;color:var(--muted);text-transform:uppercase;letter-spacing:.06em;font-weight:800;margin-bottom:8px}.nav-row{display:grid;grid-template-columns:26px 1fr;gap:8px;margin:8px 0;color:var(--soft);font-size:12px;line-height:1.35}.nav-row b{display:block;color:var(--text);font-size:12px}.nav-row span{display:block;color:var(--muted);font-size:11px}.workspace-list{display:grid;gap:7px}.workspace-item{border:1px solid var(--line);background:var(--panel);border-radius:6px;padding:8px;display:grid;gap:2px}.workspace-item.active{border-color:rgba(79,140,255,.55);box-shadow:inset 3px 0 0 var(--accent)}.workspace-item b{font-size:12px;color:var(--text);overflow:hidden;text-overflow:ellipsis;white-space:nowrap}.workspace-item span{font-size:11px;color:var(--muted);line-height:1.35;overflow:hidden;text-overflow:ellipsis;white-space:nowrap}.run-status{font-size:11px;color:var(--muted);font-weight:750}.run-status[data-kind='running']{color:var(--warn)}.run-status[data-kind='streaming']{color:var(--accent2)}.chat-thread-main{overflow:auto;padding:24px min(7vw,96px);display:grid;align-content:start;gap:14px;background:var(--editor)}.chat-thread-main .chat-bubble{max-width:min(820px,92%);font-size:14px}.chat-thread-main .chat-bubble.assistant{background:transparent;border:0;border-radius:0;padding:8px 0;justify-self:stretch;max-width:min(900px,100%)}.chat-thread-main .chat-bubble.assistant .message-head{margin-bottom:10px}.chat-thread-main .chat-bubble.assistant .copy-message{opacity:.65}.chat-thread-main .chat-bubble.assistant .copy-message:hover{opacity:1}.chat-thread-main .chat-bubble.user{max-width:min(680px,78%);border-radius:12px;padding:12px 14px}.chat-thread-main .tool-event{max-width:min(820px,92%);margin:2px 0 8px 0;background:transparent;border:0;border-left:2px solid var(--line2);border-radius:0;padding:5px 0 5px 14px}.chat-thread-main .tool-event.running{border-color:var(--warn)}.chat-composer-main{border-top:1px solid var(--line);padding:12px;background:var(--panel2);display:grid;grid-template-columns:1fr auto;gap:10px;align-items:end}.chat-composer-main textarea{min-height:72px;max-height:180px;resize:vertical}.info-card{padding:12px;border-bottom:1px solid var(--line);font-size:12px;line-height:1.45}.info-card:last-child{border-bottom:0}.info-card h3{margin:0 0 8px;font-size:12px;text-transform:uppercase;letter-spacing:.02em}.info-line{display:grid;grid-template-columns:84px 1fr;gap:8px;margin:6px 0}.info-line span:first-child{color:var(--muted);font-weight:750}.info-copy{color:var(--soft)}",
    ...
    "<div class=\"top\"><div class=\"brand\">D3 Code IDE</div><div class=\"meta\" id=\"meta\">No profile selected</div><div class=\"view-toggle\" aria-label=\"Workspace view\"><button id=\"chatModeButton\" class=\"mode-button active\" title=\"Chat mode\" aria-label=\"Chat mode\"><svg viewBox=\"0 0 24 24\" aria-hidden=\"true\"><path d=\"M21 15a4 4 0 0 1-4 4H8l-5 3V7a4 4 0 0 1 4-4h10a4 4 0 0 1 4 4z\"/><path d=\"M8 9h8M8 13h5\"/></svg></button><button id=\"editorModeButton\" class=\"mode-button\" title=\"Editor mode\" aria-label=\"Editor mode\"><svg viewBox=\"0 0 24 24\" aria-hidden=\"true\"><path d=\"M12 20h9\"/><path d=\"M16.5 3.5a2.1 2.1 0 0 1 3 3L7 19l-4 1 1-4z\"/></svg></button></div><div class=\"profile-wrap\"><button id=\"profileMenuButton\" class=\"profile-button\"><span id=\"profileButtonLabel\">Profiles</span><span>v</span></button><div id=\"profileMenu\" class=\"profile-menu\"><div><div class=\"menu-title\">Profiles</div><div class=\"menu-muted\">Add, edit, remove, or select a D3 connection profile.</div></div><div id=\"profileChoices\" class=\"profile-list\"></div><button id=\"addProfile\">Add profile</button><div class=\"theme-row\" id=\"themeRow\"><button class=\"theme-choice\" data-theme-choice=\"dark\">Dark mode</button><button class=\"theme-choice active\" data-theme-choice=\"light\">Light mode</button><button class=\"theme-choice\" data-theme-choice=\"system\">System</button></div></div></div></div>",
    "<div id=\"chatView\" class=\"chat-layout\"><aside class=\"chat-sidebar\"><div class=\"dock\"><div class=\"dock-head\"><div class=\"dock-title\">Workspace</div><button id=\"newChat\">New chat</button></div><div class=\"dock-body\"><div class=\"nav-section\"><div class=\"nav-kicker\">Active context</div><div id=\"workspaceContext\" class=\"workspace-list\"></div></div><div class=\"nav-section\"><div class=\"nav-kicker\">D3 map</div><div class=\"nav-row\"><span>@</span><span><b>Profile</b><span>Saved route into a D3 server/session.</span></span></div><div class=\"nav-row\"><span>A</span><span><b>Account</b><span>The current D3 application/database context.</span></span></div><div class=\"nav-row\"><span>F</span><span><b>Files</b><span>D-pointers/Q-pointers, records, dictionaries, BASIC.</span></span></div><div class=\"nav-row\"><span>B</span><span><b>BASIC</b><span>Programs and cataloged subroutines that drive behavior.</span></span></div></div><div class=\"nav-section\"><div class=\"nav-kicker\">Chats</div><div id=\"chatList\" class=\"chat-list\"></div></div></div></div></aside><main class=\"chat-main\"><div class=\"dock-head\"><div><div class=\"dock-title\">Agent Session</div><div class=\"dock-sub\" id=\"chatSubtitle\">No profile selected</div></div><div id=\"runStatus\" class=\"run-status\" data-kind=\"ready\">Ready</div></div><div id=\"chatOutput\" class=\"chat-thread-main\"></div><div class=\"chat-composer-main\"><textarea id=\"chatPrompt\" placeholder=\"Ask about accounts, files, dictionaries, BASIC, or what to inspect next...\"></textarea><button class=\"primary\" id=\"chatSend\">Send</button></div></main><aside class=\"chat-info\"><div class=\"dock\"><div class=\"dock-head\"><div class=\"dock-title\">Info</div><div class=\"dock-sub\" id=\"chatInfoSafety\">Safety: ask</div></div><div class=\"dock-body\"><div class=\"info-card\"><h3>Connection</h3><div class=\"info-line\"><span>Profile</span><strong id=\"chatInfoProfile\">none</strong></div><div class=\"info-line\"><span>Account</span><strong id=\"chatInfoAccount\">none</strong></div><div class=\"info-line\"><span>Model</span><strong id=\"chatInfoModel\">unknown</strong></div></div><div class=\"info-card\"><h3>D3 terms</h3><div class=\"info-copy\">A profile is the connection route. An account is the active D3 application/database context. Project names should come from D3 evidence, configuration, or the operator, not from hard-coded IDE text.</div></div><div class=\"info-card\"><h3>Last tool</h3><div id=\"chatLastTool\" class=\"info-copy\">No D3 tool has run in this browser session.</div></div></div></div></aside></div>",
    ...
    "async function copyText(text,button){try{await navigator.clipboard.writeText(text||'');const old=button.textContent;button.textContent='Copied';setTimeout(()=>button.textContent=old,900)}catch{}}",
    ...
    "function messageNode(message){message.createdAt=message.createdAt||Date.now();const div=document.createElement('div');if(message.kind==='tool'){div.className='tool-event '+(message.status==='running'?'running':'');div.dataset.rawText=message.text||'';div.innerHTML='<div class=\"message-head\"><div><div class=\"tool-name\">'+escapeHtml(message.name||'D3 tool')+'</div><div class=\"tool-status\">'+escapeHtml(message.status||'done')+' · '+escapeHtml(formatTime(message.createdAt))+'</div></div><button class=\"copy-message\" type=\"button\">Copy</button></div><div class=\"chat-tool-result\">'+escapeHtml(message.text||'running')+'</div>';div.querySelector('.copy-message').onclick=()=>copyText(div.dataset.rawText,div.querySelector('.copy-message'));return div}div.className='chat-bubble '+(message.role||'assistant');div.innerHTML='<div class=\"message-head\"><div class=\"message-meta\">'+escapeHtml(message.role==='user'?'You':'D3 Code')+' · '+escapeHtml(formatTime(message.createdAt))+'</div><button class=\"copy-message\" type=\"button\">Copy</button></div><div class=\"message-body\"></div>';div.querySelector('.copy-message').onclick=()=>copyText(div.dataset.rawText,div.querySelector('.copy-message'));updateMessageNode(div,message);return div}",
    "function activeOutput(){return document.body.dataset.view==='chat'?$('chatOutput'):$('agentOutput')}",
    ...
    "function setView(view){const next=view==='editor'?'editor':'chat';document.body.dataset.view=next;try{localStorage.setItem(CHAT_VIEW_STORE,next)}catch{}$('chatModeButton').classList.toggle('active',next==='chat');$('editorModeButton').classList.toggle('active',next==='editor');if(next==='chat')renderActiveChat()}",
    ...
    "function renderWorkspace(status){const el=$('workspaceContext');if(!el)return;const active=status.profile||'none';const account=status.account||'none';const rows=[`<div class=\"workspace-item active\"><b>${escapeHtml(active)}</b><span>Account ${escapeHtml(account)} · ${escapeHtml(status.model||'model unknown')}</span></div>`];profileCache.forEach(p=>{if(p.name===active)return;rows.push(`<div class=\"workspace-item\"><b>${escapeHtml(p.name)}</b><span>${escapeHtml(p.type||'profile')}${p.account?' · account '+escapeHtml(p.account):''}${p.host?' · '+escapeHtml(p.host):''}</span></div>`)});el.innerHTML=rows.join('')}",
    "async function boot(){const status=await api('/api/status');selectedProfile=status.profile||'';const account=status.account||'none';$('meta').textContent=status.profile?`Profile ${status.profile} / Account ${account}`:'No D3 profile selected';$('profileButtonLabel').textContent=status.profile||'Profiles';$('agentSafety').textContent=`Safety: ${status.safety||'ask'} / Mode: ${status.mode||'chat'}`;$('chatSubtitle').textContent=status.profile?`Profile ${status.profile} / Account ${account}`:'No D3 profile selected';$('chatInfoSafety').textContent=`Safety: ${status.safety||'ask'}`;$('chatInfoProfile').textContent=status.profile||'none';$('chatInfoAccount').textContent=account;$('chatInfoModel').textContent=status.model||'unknown';const profiles=await api('/api/profiles');profileCache=profiles.profiles||[];renderProfiles(status.profile||'');renderWorkspace(status);renderChatList();renderActiveChat()}",
    ...
    "async function sendPrompt(id){const input=$(id).value.trim();if(!input)return;$(id).value='';try{await streamAgent(input)}catch(error){addBubble('assistant',error.message||String(error))}}",
    ...
    "$('chatPrompt').addEventListener('keydown',e=>{if(e.key==='Enter'&&!e.shiftKey){e.preventDefault();$('chatSend').click()}});",
