...
function html(): string {
  ...
  return [
    ...
    "document.addEventListener('click',e=>{if(!e.target.closest('.control-menu')&&!e.target.closest('#composerSafety')&&!e.target.closest('#composerModel'))closeControlMenus()});",
